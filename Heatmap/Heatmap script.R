...
heatmap_for_correlation <- function(values_for_cor) {
     ...
     axis(2, at = column_for_correlation:1, labels = colnames(matrix_for_correlation), las = 2)
  
     axis(1, at = 1:column_for_correlation, labels = colnames(matrix_for_correlation), las = 2)
